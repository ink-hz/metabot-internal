...
metrics.counter('flywheel_events_accepted_total', 'Flywheel events accepted into memory');
metrics.counter('flywheel_events_committed_total', 'Flywheel events committed');
metrics.counter('flywheel_events_rejected_total', 'Flywheel events rejected');
metrics.counter('flywheel_events_duplicate_total', 'Flywheel duplicate events');
metrics.counter('flywheel_events_failed_total', 'Flywheel event writes that exhausted retries');
metrics.counter('flywheel_events_dropped_total', 'Flywheel events dropped');
